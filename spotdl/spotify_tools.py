...
def fetch_playlist(playlist):
    ...
    try:
        results = spotify.user_playlist(
            user=None, playlist_id=playlist_id, fields="tracks,images,next,name,public"
        )
...
def fetch_track_related_tracks(track):
    ...
    related_tracks = spotify.recommendations(seed_artists='', seed_genres='', seed_tracks='4fzsfWzRhPawzqhX8Qt9F3',limit=20, country="US")
